# Cooperative AI Foundation Funding Data

## Overview

This directory contains funding event data extracted from Cooperative AI Foundation.
...
- **Source Name**: Cooperative AI Foundation
- **Source URL**: https://www.cooperativeai.com/
...
1. Run dump helper:
   ```bash
   python scripts/extraction/new_dump.py --source cooperative_ai --method manual
   ```
...
5. Validate dump:
   ```bash
   python scripts/extraction/validate_dump.py --source cooperative_ai --dump YYYY-MM-DD_HHMMSS
   ```
