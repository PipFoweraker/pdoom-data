# Catalyze Impact Funding Data

## Overview

This directory contains funding event data extracted from Catalyze Impact.
...
- **Source Name**: Catalyze Impact
- **Source URL**: https://www.catalyzeimpact.org/
...
1. Run dump helper:
   ```bash
   python scripts/extraction/new_dump.py --source catalyze_impact --method manual
   ```
...
5. Validate dump:
   ```bash
   python scripts/extraction/validate_dump.py --source catalyze_impact --dump YYYY-MM-DD_HHMMSS
   ```
